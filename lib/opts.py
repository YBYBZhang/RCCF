...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('task', default='ctdet',
                             help='ctdet | ddd | multi_pose | exdet | refdet')
...
#                             help='coco | kitti | coco_hp | pascal')
    ...
    # input
    self.parser.add_argument('--dataset', type=str, default='refcoco', 
                            help="referring expression reasoning dataset, refcoco | refcoco+ | refcocog | refclef.")
    ...
    self.parser.add_argument('--lr_step', type=str, default='60,70',
    ...
    self.parser.add_argument('--data_json', type=str, default="data/coco/refcoco_unc/data.json")
    self.parser.add_argument('--data_h5', type=str, default="data/coco/refcoco_unc/data.h5")
    self.parser.add_argument('--coco_json', type=str, default="data/coco/annotations/instances_train2014.json")
...
#                'dataset': 'coco'},
#      'refdet': {'default_resolution': [512, 512], 'num_classes': 80, 
#                'mean': [0.408, 0.447, 0.470], 'std': [0.289, 0.274, 0.278],
#                'dataset': 'coco'},
