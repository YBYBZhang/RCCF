#cd src
# train
python test_ref.py refdet --resume --use_aux --test --keep_res  --exp_id coco_dla_auxloss --batch_size 1 --master_batch 16 --lr 5e-4 --gpus 1 --num_workers 2 --dense_wh --data_json data/coco/refcoco_unc/data.json --data_h5 data/coco/refcoco_unc/data.h5 --coco_json data/coco/annotations/instances_train2014.json
