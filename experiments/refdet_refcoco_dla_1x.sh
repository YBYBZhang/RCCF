#cd src
# train
python main_ref.py refdet    --exp_id coco_dla_auxloss --batch_size 32 --master_batch 15 --lr 5e-4 --gpus 0,1  --num_workers 4 --dense_wh --data_json data/coco/refcoco_unc/data.json --data_h5 data/coco/refcoco_unc/data.h5 --coco_json data/coco/annotations/instances_train2014.json
